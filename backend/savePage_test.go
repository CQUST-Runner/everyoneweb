...
func TestGetFavicon(t *testing.T) {
	// fmt.Println(getFavicon("/Users/hyan23/Desktop/everyoneweb-data/4PxR4fMH/index.html"))
	// fmt.Println(getFavicon("/Users/hyan23/Desktop/everyoneweb-data/bKbSxsQ_/index.html"))
}

func TestGetAndSaveFavicon(t *testing.T) {
	// fmt.Println(getAndSaveFavicon("/Users/hyan23/Desktop/everyoneweb-data/4PxR4fMH/index.html", "favicon.ico"))
	// fmt.Println(getAndSaveFavicon("/Users/hyan23/Desktop/everyoneweb-data/nYX7B95W/index.html", "favicon.ico"))
}
